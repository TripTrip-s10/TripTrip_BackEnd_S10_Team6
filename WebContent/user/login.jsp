            ...
            <input type="hidden" name="action" value="login" />
                <div class="col-12 login-box">
                  ...
                  <div class="col-12 login-box">
                    ...
                    <span class="join-button" id="mvjoin-button">
                        <a href="join.jsp" id="signUp">회원가입</a>
                    </span>
                    <span class="join-button" id="find-pw-button">
                        <a href="join.jsp" id="findPw">비밀번호 찾기</a>
                    </span>
                    </div>
		...
		<input type="hidden" name="action" value="find-pw" />
          ...
          <div class="modal-body">
            <div class="input-group">
              <input type="text" class="form-control" placeholder="이메일 주소" id="userid" name="userid"/>
            </div>
          </div>

          <!-- Modal footer -->
          <div class="modal-footer">
            <button type="button" class="btn btn-primary" data-bs-dismiss="modal" id="find-pw-btn">
              	메일인증하기
            </button>
          </div>
          </form>
